...
.year-in-reviews :is(h2, li)::before {
  content: none;
}
</style>

<div class="year-in-reviews box stack">
  <h2>Year in Reviews</h2>
  <ul class="cluster cluster--center">
    <li><a href="https://blog.sakupi01.com/life/articles/2024-lookback">2024</a></li>
    <li><a href="https://blog.sakupi01.com/life/articles/2025-in-review">2025</a></li>
  </ul>
</div>
...
:::figure[195件のレビューコメント]
![web.dev のレビュー量が 195件](../../../../assets/images/195comments.png)
:::

...

そして、今年もアドベントカレンダーというやつを書いてしまいました。
...
.travel-gallery .span-2 {
  grid-column: 1 / -1;
}

.travel-gallery .span-2 > img,
.travel-gallery .span-2 > p > img {
  aspect-ratio: 16 / 9;
}
</style>
...
![Penida 島, Bali](../../../../assets/images/penida2.png)
