...
:::figure[インタラクティブな要素 (出典: [HTML Standard - Kinds of content](https://html.spec.whatwg.org/multipage/dom.html#kinds-of-content))]
...
:::figure[例えば、本ブログの記事一覧ページでも、Card コンポーネントを使用しています。]
...
:::figure[リンクに対して必要以上の情報を読み上げてしまう]
