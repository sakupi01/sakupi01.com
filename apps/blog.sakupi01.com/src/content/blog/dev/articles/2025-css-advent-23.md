...
:::figure[Utopia Type Scaling (出典： [Designing with fluid type scales | Utopia](https://utopia.fyi/blog/designing-with-fluid-type-scales))]
...
:::figure[Viewport に合わせた Utopia のスケーリング (出典： [Designing with fluid type scales | Utopia](https://utopia.fyi/blog/designing-with-fluid-type-scales))]
...
:::figure[Web Design is Declarative]
