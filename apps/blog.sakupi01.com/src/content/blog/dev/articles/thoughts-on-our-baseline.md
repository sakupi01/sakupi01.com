...
:::figure[Popover API baseline 2025 newly available]
...
:::figure[HTML Dialog Element baseline widely available]
...
:::figure[利用されているブラウザの割合を statcounter からのグローバルなデータと、このブログのアクセスデータで比較したもの。最右のカラムは 2 値の差分を示す]
...
:::figure[Baseline Widely Available を基準にするのであれば、バージョン 108 以降を利用している Chrome ユーザを対象に動作保証できる可能性がある]
...
:::figure[sakupi01.com 訪問者の Baseline Target Year ごとのサポート割合]
