...
<figure>
<figcaption>W3C CEO Seth Dobbs 氏とのディナー</figcaption>
...
:::figure[会場パンパンになり、熱く意見が交わされる Open Web の breakouts]
![会場パンパンになり、熱く意見が交わされる Open Web の breakouts](../../../../assets/images/open-web.png)
:::
_会場パンパンになり、熱く意見が交わされる Open Web の breakouts_
...
<figure>
<figcaption>大阪でのお好み焼き</figcaption>
<div style="display: grid;
  grid-template-columns: repeat(auto-fit, minmax(250px, 1fr) );
 gap: 3px; place-items: center;">
...
- **Proposal: Add overscroll gestures with ability to reveal elements**
  ...
  - 要するに、スワイプジェスチャーを Web で宣言的に実装できるようにしたいというやつ \*`overscroll-area` を指定して、その領域までスクロール可能にする
...
:::figure[白熱する masonry の row/col 概念議論]
