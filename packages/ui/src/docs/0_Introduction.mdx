...
{/* # sakupi01.com | Web Components Introduction */}
...
> <sup>1</sup>
> The JavaScript-enhanced components have been authored as [HTML Web
> Components](/docs/web-components-or-custom-elements-using-web-components--docs),
> also known as `custom elements`.

> <sup>2</sup>
> To test how these enhanced components behave with JavaScript disabled, comment
> out the call to `uiInit()` in `src/javascript/index.ts`.
